			...
			<div class="span9">
                   ...
                   if(isset($_POST['submit'])){
                       ...
                       if(empty($Course_Name)){
                           ...
                           $insert="INSERT INTO course_plan(Course_Name) VALUES('$Course_Name')";
                           $insert_rows=$db->catinsert($insert);
                           if($insert_rows){
                               echo "Course insert success";
                           }else{
                               echo "Course  insert not success";
                           }
                       }
...
<div class="controls">
<input type="text"    name="Course_Name"  placeholder=" Enter Course Name" class="span8 tip" required>
</div>
</div>
