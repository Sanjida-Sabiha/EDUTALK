...
<head>
	...
	<title>Admin| Manage Courseplan</title>
...
<?php
	  ...
	  if(isset($_GET['deletecourses'])){
		...
		$deletequery="delete from course_plan where id= $deletecourses";
		$coursesdelete=$db->delete($deletequery);
		if($coursesdelete){
			echo"Courses Delete Succesfully";
		}else{
			echo"Coures Delete Not Succesfull";
	                      ...
	                      <div class="module">
							...
							<div class="module-body table">
									...
									<div class="alert alert-error">
										<br> <a href="addcourse.php">Add Courses</a> 	<?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
					       ...
					       $routine_read=$db->catselect($query);
					       if($routine_read){
						   $i=0;
						   ...
						   while( $result=$routine_read->fetch_assoc()){
			              	 ...
			              	 ?>
					             ...
					             <tr class="odd gradeX">
						             ...
						             <td><a href="edit-courses.php?editid=<?php echo $result['id']; ?>">Edit</a> || 
