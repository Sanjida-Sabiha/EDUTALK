...
<?php include('include/sidebar.php');?>				
			<div class="span9">
                   ...
                   if(isset($_POST['submit'])){
                       ...
                       if(empty($title) || empty($mainfile) || empty($date) ){
                        ...
                        move_uploaded_file($temp_file,$mainfile);
                           ...
                           $insert="INSERT INTO notice(title,notice_board,noticeDate,size,download)
						    VALUES('$title','$mainfile','$date','$file_size','')";
...
<div class="controls">
<input type="file"    name="notice_board"  class="span8 tip" required>
</div>
 </div>
...
<div class="controls">
<input type="date"    name="noticeDate"   class="span8 tip" required>
</div>
</div>
