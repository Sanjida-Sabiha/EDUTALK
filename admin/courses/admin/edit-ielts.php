		        ...
		        ?>
                  ...
                  <?php 
				   ...
				   if(isset($_POST['submit'])){
						   ...
						   $unique_file =substr(md5(time()), 0, 10).'.'.$file_ext;//random unique name define for same file name
                           ...
                           elseif($file_size>100000000){
                            ...
                            if($upadatenews){
                                echo "routine update success";
                            }else{
                                echo "routine not updated";
                            }
                        }
                   }
                  ...
                  ?>
				   ...
				   //select for edit
				    $editquery="select * from  routine where id='$editid'";
				    $get_routine = $db->catselect($editquery);
					 if($get_routine){
						 
				         while($getresult=$get_routine->fetch_assoc()){
				     ?>
...
<div class="controls">
<input type="text"    name="routine_title" value="<?php echo $getresult['routine_title']; ?>"  class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type= "text"  name="routine" value="<?php echo $getresult['routine'];?>" class="span8 tip" required>
